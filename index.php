        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="caption">
              ...
              <p>This is our official website that we will going to use it to run some of our programs and services so as to provide our teaching services using a modern way.</p>
              <p><em>Are you a parent or guardian of a child? if <b>"Yes"</b> please click the button below to create or login into an account so that you can get some update in our Madaaris</em></p>
          ...
          <div class="container">
            <div class="row">
              ...
              ?>
                ...
                <div class='col-lg-15'>
                  <h2 class='text-light text-center m-0'>news</h2>
                  <div class='row'>
                    <?php
                      ...
                      <div class='col-lg-4'>
                        <div class='meeting-item'>
                          ...
                          <div class='down-content'>
                            ...
                            <a href='#'>
                              <h4><?php echo $newest["news heading"]; ?></h4>
                            </a>
                            <p class=" text-truncate"><?php echo $newest["news content"]; ?></p>
                          </div>
                        </div>
                      </div>
                    <?php
                        ...
                        <div class="form-row">
                          <label class="form-row-inner">
                            <select name="gender" class="form-control text-center input-text" style="background: transparent !important; color: #fff;" id="" required>
                              <option value=""> </option>
                              <?php
                              $gresult = mysqli_query($db, "SELECT * FROM genders");
                              if ($gresult) {
                                while ($gloop = mysqli_fetch_assoc($gresult)) {
                              ?>
                                  <option value="<?php echo $gloop['id']; ?>"><?php echo "$gloop[gender]"; ?></option>
                              <?php
                                }
                              } else {
                                echo "query error";
